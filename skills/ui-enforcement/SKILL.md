...
3. Query live specs:  python3 skills/design-skill/query.py ds get <path>
...
- **Extend primitives** (`FieldRow`, `Button`, `ScrollBody` (ScrollBody removed), `ScrollBody`, `PanelHeader`, …) — do not paste label/layout recipes into screens
...
| `skills/design-skill/query.py` | Live design system + UX playbook |

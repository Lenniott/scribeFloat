...
- [Triage: Note written pane does not fill editor height](issues/z_08-written-pane-height.md) — **Done** already: fill-parent layout chain is correct; human confirms no longer reproduces.
- [Triage: Record vs Dictate naming / dual-controller honesty](issues/z_06-record-dictate-naming.md) — **Later**: parked to [`docs/ideas/record-dictate-capture-unification.md`](../../docs/ideas/record-dictate-capture-unification.md) (own wayfinder/branch).

...
Spun off:
- [Load Sortformer concurrently with ASR in Upload flow](./issues/35-transcribe-parallelize-sortformer-load.md)
- [Stop re-hashing Whisper model per batch item](./issues/36-transcribe-cache-whisper-hash.md)
- [Prefetch next queued item's decode](./issues/37-transcribe-prefetch-next-decode.md)

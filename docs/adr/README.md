...
| ADR-0013 | [0013-speaker-chunking-separate-from-identification.md](0013-speaker-chunking-separate-from-identification.md) | Experimental pre-Whisper chunking finds *where* voice changes; voiceprint still finds *who* |

...
| [design-brain-prd.md](design-brain-prd.md) | Float: enrichment engine (Layer/Step/Flow), HTTP inference via Ollama/cloud — Phase B of dashboard-prd |
| [knowledge-layer-intent.md](knowledge-layer-intent.md) | Intent doc: cross-transcript synthesis into knowledge artifacts (personas, project arcs, etc.) — depends on Float |
